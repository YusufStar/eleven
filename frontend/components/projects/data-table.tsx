...
import { Settings01Icon, Search01Icon, Folder01Icon } from "@hugeicons/core-free-icons";
import { cn } from "@/lib/utils";

export type ProjectsDataTableProps<TData, TValue> = {
                  ...
                  <Empty className="min-h-[280px] border-0">
                    <EmptyHeader>
                      <EmptyMedia variant="icon">
                        <HugeiconsIcon icon={Folder01Icon} className="size-5" strokeWidth={2} />
                      </EmptyMedia>
                      <EmptyTitle>No projects found</EmptyTitle>
                      <EmptyDescription>
                        {search ? "Try adjusting your search." : "You are not a member of any projects yet."}
                      </EmptyDescription>
                    </EmptyHeader>
                  </Empty>
                </TableCell>
