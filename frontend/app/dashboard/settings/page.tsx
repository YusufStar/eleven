...
export default function SettingsPage() {
  ...
  const connectUrl = typeof window !== "undefined" ? `${process.env.NEXT_PUBLIC_API_URL ?? "http://localhost:3333"}/settings/github/connect` : "";

  return (
    <div className="container mx-auto py-2">
      <h1 className="text-2xl font-semibold tracking-tight mb-2">Organization settings</h1>
